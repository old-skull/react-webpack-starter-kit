...
export const charactersInitialState: CharactersState = {
  ...
  entities: {
    '1': {
      ...
      caption:
        'Was a legendary witcher of the School of the Wolf active throughout the 13th century. He loved the sorceress Yennefer, considered...',
      description:
    ...
    '2': {
      ...
      caption:
        'Was born in 1252 or 1253, and most likely during the Belleteyn holiday. She was the sole princess of Cintra, the daughter of...',
      description:
    ...
    '3': {
      ...
      caption:
        'Better known simply as Regis, was a very powerful higher vampire, and more than four hundred years old when he first met Geralt of Rivia. He was...',
      description:
    ...
    '4': {
      ...
      caption:
        "Born on Belleteyn in 1173, was a sorceress who lived in Vengerberg, the capital city of Aedirn. She was Geralt of Rivia's true...",
      description:
